  ...
  return (
    <div className="flex flex-col items-center">
      <svg viewBox="0 0 200 200" width={size} height={size}>
        ...
        <line x1="100" y1="100" x2="100" y2="45" stroke="#374151" strokeWidth="4" strokeLinecap="round" transform={`rotate(${hourDeg} 100 100)`} />
        <line x1="100" y1="100" x2="100" y2="25" stroke="#374151" strokeWidth="2.5" strokeLinecap="round" transform={`rotate(${minuteDeg} 100 100)`} />
        <line x1="100" y1="110" x2="100" y2="20" stroke="#ef4444" strokeWidth="1" strokeLinecap="round" transform={`rotate(${secondDeg} 100 100)`} />
